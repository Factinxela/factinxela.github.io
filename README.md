...
```powershell
& ..\Factinxela\.venv-build\Scripts\python.exe .\capture_screenshots.py
```

El generador espera encontrar el repositorio de la aplicación en `..\Factinxela` y
utiliza su entorno virtual de compilación, que contiene las dependencias de PySide6.
